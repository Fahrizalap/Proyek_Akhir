    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            @if ($message = Session::get('success'))
                ...
                @endif
            <a href="{{ url('createdosen') }}" type="button" class="btn btn-success">Tambah +</a>
            <div class="row">
                <table class="table mt-2 table-success table-stripped">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ url('editdosen/'.$row->id) }}" class="btn btn-primary">Edit</a>
                                <a href="{{ url('delete/'.$row->id) }}" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
